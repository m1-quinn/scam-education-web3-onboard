...
export const DepositWeth = async (account, ethersProvider) => {
...
export const SendEth = async (account, ethersProvider) => {
    const signer = ethersProvider.getSigner()
    const tx = {
        to: account,
        value: ETHamount
...
export const RandomContract = async (account, ethersProvider) => {
    const signer = ethersProvider.getSigner()
